...
__CHEETAH_genTime__ = 1513519584.4413302
__CHEETAH_genTimestamp__ = 'Sun Dec 17 17:06:24 2017'
__CHEETAH_src__ = 'Cheetah/Templates/SkeletonPage.tmpl'
__CHEETAH_srcLastModified__ = 'Sun Dec 17 17:06:13 2017'
...
class SkeletonPage(_SkeletonPage):
    ...
    def writeHeadTag(self, **KWS):
        ...
        write('''<head>
<title>''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "title", True)  # '$title' on line 24, col 8
        if _v is not None: write(_filter(_v, rawExpr='$title'))  # from line 24, col 8.
        write('''</title>
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "metaTags", True)  # '$metaTags' on line 25, col 1
        if _v is not None: write(_filter(_v, rawExpr='$metaTags'))  # from line 25, col 1.
        write('''
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "stylesheetTags", True)  # '$stylesheetTags' on line 26, col 1
        if _v is not None: write(_filter(_v, rawExpr='$stylesheetTags'))  # from line 26, col 1.
        write('''
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "javascriptTags", True)  # '$javascriptTags' on line 27, col 1
...
''')
    ...
    def respond(self, trans=None):
        ...
        _cacheRegion_header = self.getCacheRegion(regionID='header', cacheInfo={'id': 'header', 'type': 2})
        ...
        if _RECACHE_header or not _cacheItem_header.getRefreshTime():
            ...
            _v = VFSL([locals()]+SL+[globals(), builtin], "docType", True)  # '$docType' on line 7, col 1
            if _v is not None: write(_filter(_v, rawExpr='$docType'))  # from line 7, col 1.
            write('''
''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "htmlTag", True)  # '$htmlTag' on line 8, col 1
...
Copyright ''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "currentYr", True)  # '$currentYr' on line 12, col 11
            if _v is not None: write(_filter(_v, rawExpr='$currentYr'))  # from line 12, col 11.
            write(''' - ''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "siteCopyrightName", True)  # '$siteCopyrightName' on line 12, col 24
...
provided you remove all links and/or references to ''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "siteDomainName", True)  # '$siteDomainName' on line 14, col 52
            if _v is not None: write(_filter(_v, rawExpr='$siteDomainName'))  # from line 14, col 52.
            write('''
However, please do not copy any content or images without permission.

''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "siteCredits", True)  # '$siteCredits' on line 17, col 1
...
''')
        ...
        write('''
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "bodyTag", True)  # '$bodyTag' on line 34, col 1
