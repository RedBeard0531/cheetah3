...
__CHEETAH_genTime__ = 1513519678.5352957
__CHEETAH_genTimestamp__ = 'Sun Dec 17 17:07:58 2017'
...
<title>''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$title'))  # noqa: E501; from line 25, col 8.
        write('''</title>
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "metaTags", True)  # noqa: E501; '$metaTags' on line 26, col 1
        if _v is not None: write(_filter(_v, rawExpr='$metaTags'))  # noqa: E501; from line 26, col 1.
        write('''
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "stylesheetTags", True)  # noqa: E501; '$stylesheetTags' on line 27, col 1
        if _v is not None: write(_filter(_v, rawExpr='$stylesheetTags'))  # noqa: E501; from line 27, col 1.
        write('''
''')
        _v = VFSL([locals()]+SL+[globals(), builtin], "javascriptTags", True)  # noqa: E501; '$javascriptTags' on line 28, col 1
        if _v is not None: write(_filter(_v, rawExpr='$javascriptTags'))  # noqa: E501; from line 28, col 1.
        write('''
</head>
''')
...
''')
    ...
    def respond(self, trans=None):
        ...
        if _RECACHE_header or not _cacheItem_header.getRefreshTime():
            ...
            if _v is not None: write(_filter(_v, rawExpr='$docType'))  # noqa: E501; from line 8, col 1.
            write('''
''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "htmlTag", True)  # noqa: E501; '$htmlTag' on line 9, col 1
            if _v is not None: write(_filter(_v, rawExpr='$htmlTag'))  # noqa: E501; from line 9, col 1.
            write('''
...
Copyright ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$currentYr'))  # noqa: E501; from line 13, col 11.
            write(''' - ''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "siteCopyrightName", True)  # noqa: E501; '$siteCopyrightName' on line 13, col 24
            if _v is not None: write(_filter(_v, rawExpr='$siteCopyrightName'))  # noqa: E501; from line 13, col 24.
...
provided you remove all links and/or references to ''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$siteDomainName'))  # noqa: E501; from line 15, col 52.
            write('''
However, please do not copy any content or images without permission.

''')
            _v = VFSL([locals()]+SL+[globals(), builtin], "siteCredits", True)  # noqa: E501; '$siteCredits' on line 18, col 1
            if _v is not None: write(_filter(_v, rawExpr='$siteCredits'))  # noqa: E501; from line 18, col 1.
            write('''
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$bodyTag'))  # noqa: E501; from line 35, col 1.
        write('''
